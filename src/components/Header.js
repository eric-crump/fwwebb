...
function Header() {
    return (
        ...
        //                     <li className=""><a href="/locations/" aria-label="locations"> <span className="w-100"><i className="fas fa-map-marker-alt"></i></span>&nbsp;&nbsp;LOCATIONS</a></li>

        //                     <li className="d-md-inline d-none d-sm-none px-4"><a href="/contacts.php" aria-label="contact">CONTACT US</a></li>
        //                 </ul>
        //             </div>
